...
[role="lead"]
Sie können bestehende Speichervolumes als Kubernetes PV importieren, indem Sie `tridentctl import` verwenden oder indem Sie einen Persistent Volume Claim (PVC) mit Trident-Importannotationen erstellen.
