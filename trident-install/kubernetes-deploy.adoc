...
====
.<strong>Kubernetes-Clusterverwaltung mit der NetApp Console</strong>
[%collapsible]
====
Mit Astra Trident können Sie mithilfe der NetApp Console ein Upgrade auf die neueste Version von Astra Trident durchführen, Speicherklassen hinzufügen und verwalten, sie mit Arbeitsumgebungen verbinden und persistente Volumes mithilfe des Cloud Backup Service sichern. Die Konsole unterstützt die Astra Trident Bereitstellung mithilfe des Trident -Operators, entweder manuell oder mithilfe von Helm.
