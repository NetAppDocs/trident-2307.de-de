...
Astra Trident verwendet den  `azure-netapp-files` Treiber zur Verwaltung des link:hhttps://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Dateien"^] Service.
